      ...
      <div className="hidden lg:flex lg:w-1/2 bg-peri-dark p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 my-auto max-w-md">
          ...
          <h1 className="text-4xl lg:text-5xl font-black text-white mt-4 tracking-tight leading-tight">
            Start building your code projects today.
          </h1>
          <p className="text-sm text-peri-light/80 mt-4 leading-relaxed font-medium">
            Create your account to unlock your developer workspace and manage assignments.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-cream overflow-y-auto">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-black text-peri-dark tracking-tight">Join DevCode</h2>
            <p className="text-xs text-gray-500 font-medium">Enter your details to register your new account.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-peri-dark">Username</label>
              <input 
                type="text" 
                placeholder="johndoe" 
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-gray-500 font-medium">
              ...
              <Link to="/login" className="text-peri-dark font-bold hover:underline">
                Login here
              </Link>
            </p>
          </div>
